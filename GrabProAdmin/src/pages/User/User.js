...
const User = () => {
    ...
    const [responseLocation, errorAccountLocation, isLoadingAccountLocation] = useAxios(
        'get',
        '/user/location',
        {},
        {},
    ...
    return (
        <div className={classes.user}>
            <div
                className={classes.user__wrapper}
                ...
                <div className={classes.user__header}>
                    <div className={classes['user__header--left']}>
                        <p
                            onClick={handleTab}
                            className={
                                classes[isTab === 'Customer' ? 'user__header--left-active' : 'user__header--left-none']
                            }
                        >
                            Customer
                        </p>
                        <span
                            onClick={handleTab}
                            className={
                                classes[isTab === 'Driver' ? 'user__header--left-active' : 'user__header--left-none']
                            }
                        >
                            Driver
                        </span>
                        <span
                            onClick={handleTab}
                            className={
                                classes[isTab === 'Staff' ? 'user__header--left-active' : 'user__header--left-none']
                            }
                        >
                            Staff
                        </span>
                ...
                <div className={classes.user__table}>
                    ...
                    <div className={classes['user__table--list']}>
                        {renderData.map((item, index) => (
                            <div
                                className={classes['user__table--row']}
                                key={+index}
                            ...
                            >
                                ...
                                <p
                                    style={{
                                        width: '16%',
                                        color: item.status === 1 ? '#FF2F2F' : 'Hoạt động' ? '#00B14F' : 'black',
                                    }}
                                >
