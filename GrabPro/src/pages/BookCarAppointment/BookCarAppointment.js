  ...
  if (!fontsLoaded) {
    ...
    return (
      <View style={styles.bookcarappointment__container}>
        ...
        <Pressable
          style={styles["bookcarappointment__container-back"]}
          onPress={() => navigation.navigate("/bookcar-home")}
        >
        ...
        >
          <View style={styles["bookcarappointment__container-timer"]}>
            <Text style={styles["bookcarappointment__container-timer-title"]}>
              Chọn khung giờ:
            </Text>

            <Text style={styles["bookcarappointment__container-timer-content"]}>
              8 : 45 25/06/2023
            </Text>
          ...
          <Pressable onPress={() => navigation.navigate("/bookcar-destroy")}>
            <Text style={styles["bookcarappointment__container-button"]}>
              Đặt xe GrabCar
            </Text>
          </Pressable>
        </View>
