            ...
            <View style={styles.bookcar__container}>
                ...
                <View style={{position: "absolute", backgroundColor: "#fff", width: "100%", bottom: 0}}>
                    <View style={styles["bookcar__container-timer"]}>
                        <Text style={styles["bookcar__container-timer-title"]}>Chọn khung giờ:</Text>
    
                        <Text style={styles["bookcar__container-timer-content"]}>8 : 45   25/06/2023</Text>
                    ...
                    <View style={styles["bookcar__container-location"]}>
                        ...
                        <Text style={styles["bookcar__container-location-price"]}>61.000đ</Text>
                    </View>
                    ...
                    <View style={styles["bookcar__container-payment"]}>
                        <View style={styles["bookcar__container-payment-left"]}>
                            <View style={{display:"flex", alignItems: "center", flexDirection: 'row'}}>
                                ...
                                <Text style={styles["bookcar__container-payment-left-title"]}>Tiền mặt</Text>
                            </View>
                        ...
                        <View style={styles["bookcar__container-payment-right"]}>
                            <Text style={styles["bookcar__container-payment-right-title"]}>Ưu đãi</Text>
                        </View> 
                    </View>
